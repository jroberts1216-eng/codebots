CREATE OR REPLACE VIEW `<PROJECT_ID>.<DATASET_ANALYTICS>.vw_cases_current_dev` AS
SELECT * EXCEPT(rn)
FROM (
  SELECT
    ...
    -- TODO: map these to your actual source timestamp columns if names differ
  ...
  FROM `<PROJECT_ID>.<DATASET_ANALYTICS>.ext_cases_avro_dev`
